...
from afa_modules.bn_markov_blanket import MB
from afa_modules.bn_learn import GS
...
save_dir = os.path.join(params.exp_dir, 'bn_estimate')
os.makedirs(save_dir, exist_ok=True)
logging.basicConfig(filename=save_dir + '/bn_estimate.log',
                    filemode='w',
                    level=logging.INFO,
                    format='%(message)s')
