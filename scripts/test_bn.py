...
from afa_modules.bn_afa import AFA
from utils.hparams import HParams
from utils.visualize import show_graph, show_mask
...
setattr(params, 'dataset', 'bn')
setattr(params, 'rnd_rate', -1)
...
save_dir = os.path.join(params.exp_dir, 'test_bn')
...
# AFA
afa = AFA(params, model, testset.graph)
...
for i in range(10):
    fname = f'{vis_dir}/{i}.png'
    show_graph(testset.graph, masks[i], fname)